...
def build_server() -> StdioMCPServer:
    ...
    return StdioMCPServer(name="freemium-data-demo", version="1.0.0", tools=tools, handlers={"search_business": demo.search_business, "purchase_business": demo.purchase_business, "match_business": demo.match_business, "enrich_business": demo.enrich_business})
