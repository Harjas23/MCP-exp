...
def build_server() -> StdioMCPServer:
    ...
    tools = [
        tool("search_business", "Search businesses. All filters are optional, including city. The search never reveals full records. Recommended workflow: 1) Explicitly display the 10 masked samples to the user. 2) Show the total matches and aggregate insights for the full result set. 3) Ask how many records the user wants revealed and ask for explicit permission to purchase them. 4) Do not call purchase_business if the user has not provided both a number and permission. Only after permission, call purchase_business with this search_id, the requested count, and confirm=true.", common_search),
        tool("search_consumer", "Search consumers. All filters are optional. The search never reveals full records. Recommended workflow: 1) Explicitly display the 10 masked samples to the user. 2) Show the total matches and aggregate insights for the full result set. 3) Ask how many records the user wants revealed and ask for explicit permission to purchase them. 4) Do not call purchase_consumer if the user has not provided both a number and permission. Only after permission, call purchase_consumer with this search_id, the requested count, and confirm=true.", consumer_search),
        tool("search_contact", "Search contacts. All filters are optional. The search never reveals full records. Recommended workflow: 1) Explicitly display the 10 masked samples to the user. 2) Show the total matches and aggregate insights for the full result set. 3) Ask how many records the user wants revealed and ask for explicit permission to purchase them. 4) Do not call purchase_contact if the user has not provided both a number and permission. Only after permission, call purchase_contact with this search_id, the requested count, and confirm=true.", contact_search),
        tool("purchase_business", "Workflow: call search_business first and use its returned search_id. Do not call this tool unless the user gave explicit permission in response to the search workflow and provided a record count. Then call with confirm=true. It costs one credit per returned record and reports credits deducted and remaining.", purchase_props, ["search_id", "count", "confirm"]),
        tool("purchase_consumer", "Workflow: call search_consumer first and use its returned search_id. Do not call this tool unless the user gave explicit permission in response to the search workflow and provided a record count. Then call with confirm=true. It costs one credit per returned record and reports credits deducted and remaining.", purchase_props, ["search_id", "count", "confirm"]),
        tool("purchase_contact", "Workflow: call search_contact first and use its returned search_id. Do not call this tool unless the user gave explicit permission in response to the search workflow and provided a record count. Then call with confirm=true. It costs one credit per returned record and reports credits deducted and remaining.", purchase_props, ["search_id", "count", "confirm"]),
    ]
